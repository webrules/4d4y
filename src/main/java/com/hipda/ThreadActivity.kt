...
class ThreadActivity : AppCompatActivity() {
    ...
    private var formhash: String? = "b255b915"
...
//                        formhash = extractFormHash(content)
//                        fid = extractFid(content)
    ...
    private fun extractFormHash(content: String): String? {
...
//    }
    ...
    private fun postReply() {
        ...
        val requestBody = "formhash=58734250&subject=&usesig=0&message=".plus(URLEncoder.encode(message,"GBK"))
